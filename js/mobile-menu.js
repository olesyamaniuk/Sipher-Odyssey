document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".sipher-navigation-list");
  const headerRef = document.querySelector(".sipher-header");
  const navigationRef = document.querySelector(".sipher-navigation");
